export const metadata = {
  title: 'Modal - @kaynora/ui',
  description: 'A dialog component that captures user attention.',
}
...
# Modal
<P>
A dialog component that captures user attention with focus management, 
backdrop click handling, and nested modal support.
</P>
<ModalDisplay />
```jsx
